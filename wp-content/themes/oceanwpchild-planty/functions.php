...
// Menu dans Apparence > Menus dans l'interface d'administration de WordPress
...
// Ajout du lien Admin dans le Menu Header Planty
function lien_admin($items, $args) {
    if (is_user_logged_in() && $args->theme_location === 'menu-header-planty') {
